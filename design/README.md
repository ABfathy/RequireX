...
:root {
  /* Fonts */
  --font-sans: "Geist", ui-sans-serif, system-ui, -apple-system, Helvetica, Arial, sans-serif;
  ...
  /* Elevation */
  --shadow-sm: 0 1px 2px rgba(0,0,0,0.32), 0 0 0 1px rgba(0,0,0,0.40);
  --shadow-md: 0 6px 16px rgba(0,0,0,0.40), 0 2px 4px rgba(0,0,0,0.30), 0 0 0 1px rgba(0,0,0,0.50);
  --shadow-lg: 0 24px 48px rgba(0,0,0,0.55), 0 8px 16px rgba(0,0,0,0.40), 0 0 0 1px rgba(0,0,0,0.50);
}
...
[data-theme="light"] {
  ...
  --accent:        #3d6b87;
  --accent-subtle: rgba(61,107,135,0.10);
  --accent-ring:   rgba(61,107,135,0.38);
  --accent-fg:     #ffffff;

  --success:  #4f8a5a;  --warning: #a87527;
  --danger:   #a05248;  --info:    #3d6b87;

  --shadow-sm: 0 1px 2px rgba(34,30,22,0.06), 0 0 0 1px rgba(34,30,22,0.06);
  --shadow-md: 0 6px 18px rgba(34,30,22,0.10), 0 2px 4px rgba(34,30,22,0.05), 0 0 0 1px rgba(34,30,22,0.06);
  --shadow-lg: 0 30px 60px rgba(34,30,22,0.18), 0 8px 16px rgba(34,30,22,0.08), 0 0 0 1px rgba(34,30,22,0.06);
}
...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "2xs": "10px", xs: "11px", sm: "12px",
        base: "13px", md: "15px", lg: "17px",
        xl: "21px", "2xl": "25px",
      },
      colors: {
        background:  "var(--background)",
